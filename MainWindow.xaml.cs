...
namespace dataBaseWPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            {"Группа",1 }, {"Вид родственника",2 }, {"Льгота",3 }, {"Персона", 4 },{"Студент", 5 },{"Факультет",6 },{"Родственные связи",7 }
        };
        ...
        {
            {"Студенты, родившиеся после 2000", 1 }, {"Вид родственника по дальности", 2}, {"ИТОГИ Количество студентов", 3},
        ...
        {
            {"Родственники по льготе", 1}, {"Студенты с фамилией", 2}, {"Факультет Запрос", 3}
        };
